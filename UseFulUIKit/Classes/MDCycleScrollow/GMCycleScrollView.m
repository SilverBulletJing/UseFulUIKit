...
-(void)setUpPageControl{
    if (!_pageControl) {
        ...
        UIImage *nonSel = [UITools imageWithColor:RGBA(0, 0, 0, 0.2) size:CGSizeMake(7*kWidthRatio, 2*kWidthRatio)];
        UIImage *sel = [UITools imageWithColor:RGBA(255, 255, 255, 1) size:CGSizeMake(7*kWidthRatio, 2*kWidthRatio)];
